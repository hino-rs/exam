...
input:focus, select:focus { border-color:var(--u-primary); box-shadow:var(--u-focus); }
.u-btn-submit {
...
<h2 class="u-page-title">ユーザー情報変更</h2>

<div class="u-sub-nav">
    <a href="UserPasswordUpdate.action?id=${id}" class="u-sub-link">
        パスワードを変更する場合はこちら
    </a>
</div>
...
<div class="u-card">
    <form action="UserUpdateExecute.action" method="post">
        ...
        <div class="u-field">
            <span class="u-label">ID</span>
            <div class="u-readonly"><c:out value="${id}" /></div>
            <input type="hidden" name="id" value="${id}">
        </div>

        <div class="u-field">
            <label class="u-label" for="u-name">名前</label>
            <input type="text" id="u-name" name="name" value="${name}" required>
