...
<div class="u-alert-success">登録が完了しました</div>

<div class="u-nav">
    <a href="UserCreate.action" class="u-link">続けて登録</a>
    <a href="UserList.action" class="u-link">ユーザー一覧</a>
</div>
